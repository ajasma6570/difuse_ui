...
const products = [
  {
    name: "DPBX 50",
    img: Images.DPBX.Devices.DPBX50.Desktop,
    mobileImg: Images.DPBX.Devices.DPBX50.Mobile,
        ...
        <div className="md:max-w-8xl w-full px-6 py-16">
          <div className="mx-auto w-full space-y-6 text-center md:max-w-6xl">
            ...
            <p className="mx-auto max-w-4xl text-center text-lg font-light text-[#2A2A2A]">
              ...
              bloated licensing costs. Engineered to run on open standards and
              self-hosted environments, DPBX brings scalable telephony to your
              fingertips — whether you&lsquo;re a growing startup or a
            ...
            <div className="md:max-w-8xl relative h-[650px] w-full overflow-hidden rounded-lg shadow-sm">
              <picture>
                <source
                  ...
                  srcSet={Images.DPBX.Banner.Mobile.src}
                />
                <Image
                  src={Images.DPBX.Banner.Desktop.src}
                  alt="DPBX Devices Banner"
                  fill
                  quality={100}
          ...
          <p className="mx-auto mt-10 max-w-4xl text-center text-lg font-light text-[#2A2A2A]">
            ...
            call routing, IVR, recording, and SIP trunking, all without cloud
            lock-ins or licensing traps. With scalable deployment options and
            full admin control, DPBX devices empower businesses to own their
