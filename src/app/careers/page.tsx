        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
          <div className="space-y-6 col-span-12 md:col-span-8">
            ...
            <p className="md:w-3/4 text-[#080808] text-lg">
              ...
              a culture where talent thrives, ideas are heard, and contributions
              truly matter. Whether you’re an engineer shaping network
              infrastructure, a designer redefining user experiences, or a
              strategist driving market expansion, you’ll have the autonomy and
        ...
        <div className="bg-[#F4F4F4] mt-20 rounded-xl overflow-hidden p-20 space-y-14">
          <div className="flex flex-col md:flex-row px-8 lg:px-16  gap-10">
            ...
            <div className="flex md:w-1/2 flex-col space-y-6">
              <p className="text-lg">
                We hire for skill, drive, and problem-solving ability, not just
                job titles. If you’re passionate about creating meaningful
                technology and want to see your work make a real difference, you
                belong here.
              </p>
              <AnimatedSlideButton
