  ...
  return (
    <html lang="en">
      ...
      <body className={`${poppins.variable} font-poppins antialiased`}>
        <div className="fixed top-20 left-0 z-[100] flex w-[30px] items-center justify-center bg-gray-200 py-[2.5px] text-[12px] text-black uppercase sm:bg-red-200 md:bg-yellow-200 lg:bg-green-200 xl:bg-blue-200 2xl:bg-pink-200">
